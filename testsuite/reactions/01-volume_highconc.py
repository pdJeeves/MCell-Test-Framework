...
t = McellTest("01-volume_highconc")
...
rxn_out = rxn_out.after(5e-3);
rxn_out.base_time = 0.0;

rxn_out[0:6]  == equilibrium(1e5, 1.5e4);
rxn_out[7]    == equilibrium(3.33e4, 5e3);
rxn_out[8:14] == equilibrium(1e5, 1.5e4);
rxn_out[15]   == equilibrium(3.33e4, 5e3);
